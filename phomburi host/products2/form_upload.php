	...
	<form action="save_image.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
		...
		<div class="form-row">
			<label>
				...
				<input type="text" name="txtpdname" id="txtpdname" />
			</label>
		</div>
<div class="form-row">
			<label>
				<span>ราคา</span>
				<input type="text" name="txtpdprice" id="txtpdprice" />
			</label>
		</div>
<div class="form-row">
			<label>
				<span>จำนวณ</span>
				<input type="text" name="txtpdcount" id="txtpdcount" />
			</label>
		</div>
		<div class="form-row">
			<label>
...
function myFunction() {
    alert("เพิ่มข้อมูลเรียบร้อย");
            ...
            <a href="index1111.php"> <input class="ok2" type="button" value="กลับ"/></a>
		</div>
