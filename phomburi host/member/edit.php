...
<?php include"head/head.php" ?>
	...
	<form action="edit_save.php?id=<?php echo $_GET["id"];?>" method="post">
		...
		<div class="form-row">
			<label>
				<span>ชื่อ</span>
				<input type="text" name="txtname" id="txtname" value="<?php echo $objResult["name"];?>" readonly>
			</label>
		</div>
<div class="form-row">
			<label>
				<span>นามสกุล</span>
				<input type="text" name="txtlastname" id="txtlastname" value="<?php echo $objResult["lastname"];?>" readonly>
			</label>
		</div>
		<div class="form-row">
			<label>
				<span>เบอร์โทรศัพท์</span>
				<input type="text" name="txtmobile" id="txtmobile" value="<?php echo $objResult["mobile"];?>" readonly>
			</label>
		</div>
<div class="form-row">
			<label>
				<span>ชื่อผู้ใช้</span>
				<input type="text" name="txtusername" id="txtusername" value="<?php echo $objResult["username"];?>" readonly>
			</label>
		</div>
		<div class="form-row">
			<label>
...
<div class="form-row">
			<label>
				<span>ที่อยู่</span>
				<input type="text" name="txtaddress" id="txtaddress" value="<?php echo $objResult["address"];?>" readonly>
			</label>
		</div>
		<div class="form-row">
