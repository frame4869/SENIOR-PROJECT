  ...
  <table class="container">
    ...
    <tbody>
      <tr>
        ...
        <td ><a href="view.php?id=<?php echo $objResult["id"];?>">
        ...
        <td ><a href="edit.php?id=<?php echo $objResult["id"];?>">
          <input class="MyButton" type="button" value="แก้ไขรหัสผ่าน" onClick="window.location.href='http://www.hyperlinkcode.com/button-links.php'" />
        </a></td>
...
<br>
  <td >
  <tr><a href="form_add.php?id=<?php echo $objResult["id"];?>">
  <input class="ok2" name="submit" type="submit" value="เพื่มข้อมูล" >
    </a>
    </td>
  </tr>
</div>
