...
$strSQL .=" order by OrderID ASC LIMIT $Page_Start , $Per_Page";
    ...
    <thead>
      <tr>
        <th><h1>รหัสสินค้า</h1></th>
				<th><h1>จำนวณที่ยืม</h1></th>
        <th><h1>ชื่อลูกค้า</h1></th>
        <th><h1>วันที่ยืมสินค้า</h1></th>

				<th><h1>สถานะ</h1></th>
				<th><h1>แก้ไขสถานะ</h1></th>
        <th><h1></h1></th>
				<th><h1></h1></th>
      </tr>
    </thead>
    ...
    <tbody>
      <tr>
        	...
        	<td ><?php echo $objResult["Date"];?></td>
					...
					<td><input class="MyButton5" type="button" value="<?php echo $objResult["status"];?>"/></a></td>
					<td>
					</form>

					<div>
						<form class="form" name="form1" method="post" action="edit_status_save.php?id=<?php echo $objResult["OrderID"];?>" enctype="multipart/form-data">
					...
					<input type="submit" value="ตกลง"onclick="myFunction()">
						...
						<td ><a href="edit.php?id=<?php echo $objResult["id"];?>">
							<input class="MyButton" type="button" value="คืนสินค้า"/>
