...
<?php
	...
	$strSQL = "SELECT * FROM orders_detail2
	WHERE DetailID = '".$_GET["id"]."'";
...
<?php include"head/head.php" ?>
	...
	<form action="edit_save.php?id=<?php echo $_GET["id"];?>" method="post">
		...
		<div class="form-row">
			<label>
				<span>จำนวณสินค้าที่ถูกยืม</span>
				<input type="text" name="txtName" id="txtName" value="<?php echo $objResult["Qty"];?>" required>
			</label>
		</div>
<div class="form-row">
			<label>
