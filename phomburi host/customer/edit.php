...
<div class="form-row">
		...
		<div class="form-row">
			<label>
				...
				<input type="text" name="txtctmobile" id="txtctmobile" value="<?php echo $objResult["ctmobile"];?>" required>
			</label>
		</div>
<div class="form-row">
			<label>
				<span>ที่อยู่</span>
				<input type="text" name="txtctaddress" id="txtctaddress" value="<?php echo $objResult["ctaddress"];?>" required>
			</label>
		</div>
