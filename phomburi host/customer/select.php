...
$strSQL .=" order  by ctid ASC LIMIT $Page_Start , $Per_Page";
...
<br>
  <td >
	<a href="form_add.php?id=<?php echo $objResult["ctid"];?>"><input class="ok2" name="submit" type="submit" value="เพื่มข้อมูล"></a>
    </a>
    </td>
  </tr>
</div>
