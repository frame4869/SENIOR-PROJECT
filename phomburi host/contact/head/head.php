...
<header class="header-two-bars">
	...
	<div class="header-second-bar">
		...
		<div class="header-limiter">
			...
			<nav> <a href="../bill2/select.php"><i class="fa fa-file-text"></i>รายการยืม - คืนสินค้า</a>
            <a href="../member/select.php"><i class="fa fa-file-text"></i> รายชื่อผู้ใช้ระบบ</a>
				<a href="../contact/select.php"><i class="fa fa-group"></i> ติดต่อ</a>
