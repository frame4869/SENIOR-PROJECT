	...
	<form action="save_image.php?id=<?php echo $_GET["id"];?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
		...
		<div class="form-row">
					<label>
						...
						<input type="text" name="txtpdcount1" id="txtpdcount1" value="<?php echo $objResult["pdcount"];?>" onkeyup='plus()' required>
					</label>
				</div>
<div class="form-row">
			<label>
				<span>จำนวณ</span>
				<input type="text" name="txttotal" id="txttotal" onkeyup='plus()'  />
			</label>
		</div>
